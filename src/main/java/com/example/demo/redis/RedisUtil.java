...
public class RedisUtil {
    ...
    @Autowired
    private static RedisTemplate<Object, Object> redisTemplate = new RedisTemplate<Object,Object>();
    ...
    public static long sSet(String key, Object...values) {
        try {
            return redisTemplate.opsForSet().add(key, values.toString());
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public static boolean lUpdateIndex(String key, long index,Object value) {
        try {
            redisTemplate.opsForList().set(key, index, String.valueOf(value));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
